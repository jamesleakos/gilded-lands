...
var MoveCardEffect = /** @class */ (function (_super) {
    ...
    MoveCardEffect.prototype.targetCriteriaList = function () {
        return [];
    };
    // #endregion
    ...
    MoveCardEffect.prototype.areTargetsAvailable = function (state, sourceEntity, targetCriterias) {
        return true;
    };
    MoveCardEffect.prototype.isTargetInfoValid = function (sourceEntity, state, targetInfo, targetCriteria) {
        return true;
    };
