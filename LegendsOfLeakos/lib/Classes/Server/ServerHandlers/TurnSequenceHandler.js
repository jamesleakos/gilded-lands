...
var TurnSequenceHandler = /** @class */ (function (_super) {
    __extends(TurnSequenceHandler, _super);
    function TurnSequenceHandler(gameServer) {
        return _super.call(this, gameServer) || this;
    }
    TurnSequenceHandler.prototype.registerNetworkHandlers = function (playerSockets) {
        var _this = this;
        var _loop_1 = function (socket) {
            socket.on(Networking_1.NetworkProtocol.PlayerReadyForQueue.toString(), function (data) {
    ...
    TurnSequenceHandler.prototype.unregisterNetworkHandlers = function (playerSockets) {
        for (var _i = 0, playerSockets_2 = playerSockets; _i < playerSockets_2.length; _i++) {
            var socket = playerSockets_2[_i];
            socket.removeAllListeners(Networking_1.NetworkProtocol.PlayerReadyForQueue.toString());
        }
    };
    TurnSequenceHandler.prototype.OnPlayerFinishedAddedingToQueue = function (playerSocket, data) {
        // get the player from the socket_id
    ...
    return TurnSequenceHandler;
}(ServerHandler_1.default));
exports.default = TurnSequenceHandler;
